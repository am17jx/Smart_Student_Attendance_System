...
import { generateQrForSession, scanQrAndAttend, getSessionQrCodes, getSessionOtp } from "../controllers/QrcodeController";
...
router.get("/otp/:session_id", generalLimiter, teacherAuthMiddleware, validateRequest, getSessionOtp);
