...
import { createMaterial, deleteMaterial, getAllMaterials, updateMaterial, getMaterialsByDepartment, getMaterialsByStage, assignTeacherToMaterial, removeTeacherFromMaterial } from "../controllers/MaterialController";
